...
const marketSegments = [
  { segment: "Luxury", share: 35, revenue: "$14.7B", growth: "+4.2%", color: "bg-purple-400/60" },
  { segment: "Premium", share: 28, revenue: "$11.8B", growth: "+6.1%", color: "bg-purple-400/40" },
  { segment: "Mid-range", share: 22, revenue: "$9.2B", growth: "+3.8%", color: "bg-purple-400/25" },
  { segment: "DTC / Indie", share: 15, revenue: "$6.3B", growth: "+12.4%", color: "bg-purple-400/15" },
];
  ...
  return (
    <div className="min-h-screen bg-[#070707]">
      ...
      <section className="relative pt-20 lg:pt-28 pb-16 overflow-hidden">
        ...
        <div className="absolute top-40 right-0 w-[500px] h-[500px] bg-purple-500/[0.02] rounded-full blur-[120px]" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 mb-6">
                ...
                <span className="text-xs text-purple-400/80 uppercase tracking-[0.15em]">Market Analysis</span>
              </div>
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden bg-[#0C0C0C] border border-purple-500/10 shadow-2xl shadow-purple-500/5">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-end gap-4 h-40 mb-4 px-4">
                    {marketSegments.map((seg, i) => (
                      <div key={i} className="flex-1 flex flex-col items-center gap-2">
                        ...
                        <div className={cn("w-full rounded-t-lg", seg.color)} style={{ height: `${seg.share * 3}px` }} />
                  ...
                  <div className="border-t border-white/[0.06] pt-3">
                    ...
                    {marketSegments.map((seg, i) => (
                      <div key={i} className="grid grid-cols-4 gap-2 py-1.5 border-b border-white/[0.03]">
                        ...
                        <span className="text-[10px] text-green-400/60">{seg.growth}</span>
                        <span className="text-[10px] text-white/40">{seg.share}%</span>
                      </div>
                    ))}
                  </div>
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <span className="text-[10px] text-purple-400/40">Page 5 of 18</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {capabilities.map((cap, i) => {
                const Icon = cap.icon;
                return (
                  <div key={i} className="group p-6 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-purple-500/20 hover:bg-purple-500/[0.02] transition-all">
                    <Icon className="w-5 h-5 text-white/40 group-hover:text-purple-400/70 transition-colors mb-3" />
                ...
                <div key={i} className="flex gap-6 relative">
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full bg-purple-500/10 border border-purple-500/20 flex items-center justify-center shrink-0">
                      <span className="text-xs font-mono text-purple-400/80">{step.step}</span>
                    </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3 p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]">
                  <Check className="w-4 h-4 text-purple-400/60 shrink-0" />
