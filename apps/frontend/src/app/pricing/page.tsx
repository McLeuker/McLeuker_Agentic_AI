...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "All 10 domains + custom integrations",
...
const comparisonFeatures = [
  ...
  { category: "Domain Access", features: [
    { name: "Number of domains", free: "All 10", standard: "All 10", pro: "All 10", enterprise: "All 10 + Custom" },
    ...
    { name: "Beauty & Skincare", free: true, standard: true, pro: true, enterprise: true },
    { name: "Sustainability", free: true, standard: true, pro: true, enterprise: true },
    { name: "Fashion Tech", free: true, standard: true, pro: true, enterprise: true },
    { name: "Catwalks & Culture", free: true, standard: true, pro: true, enterprise: true },
    { name: "Textile & Lifestyle", free: true, standard: true, pro: true, enterprise: true },
  ]},
...
const faqs = [
  ...
  { q: "How does domain access work?", a: "All 10 specialized research domains (Fashion, Beauty, Skincare, Sustainability, Fashion Tech, Catwalks, Culture, Textile, Lifestyle, and Global) are available to every user on every plan, including Free. The difference between plans lies in credits, research modes, export capabilities, and support levels." },
