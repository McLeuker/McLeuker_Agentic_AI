"""
AI Excel Agent — Advanced Spreadsheet Creation & Analysis
==========================================================
...
Integrates with kimi-2.5 for intelligent data handling.
"""
...
def get_excel_agent(llm_client: openai.AsyncOpenAI = None) -> ExcelAgent:
