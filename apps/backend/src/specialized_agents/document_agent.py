"""
AI Document Agent — Professional Document Generation
=====================================================

Creates professional documents (DOCX, PDF) from natural language descriptions.
...
def get_document_agent(llm_client: openai.AsyncOpenAI = None) -> DocumentAgent:
