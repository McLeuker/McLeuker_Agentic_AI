"""
AI Slides Generator Agent — Professional Presentation Creation
===============================================================

Creates professional presentations (PPTX) from natural language descriptions.
Supports rich templates, layouts, charts, and visual elements.

Features:
- Template-based slide generation
- Multiple slide layouts (title, content, two-column, image, chart)
- Automatic content structuring
- Visual design with themes
...
def get_slides_agent(llm_client: openai.AsyncOpenAI = None) -> SlidesAgent:
